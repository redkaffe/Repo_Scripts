...
set LOGFILE3=%SystemDrive%\Temp\ApplicationLogs\AdobeReaderDC.log

REM Install MSI
echo Install VM Ware Workspace One Client >> %LOGFILE1%
msiexec /i "AirWatchAgent.msi" /q ENROLL=Y SERVER=ds112.airwatchportals.com LGName=WKSWSO USERNAME=staging@wkswso.com PASSWORD=E+9kxu DOWNLOADWSBUNDLE=TRUE /LOG %LOGFILE1%
...
REM Install EXE
echo Install AdobeReaderDC >> %LOGFILE3%
SetupAdobeAcrobatDC.exe /sAll /qf /quiet %LOGFILE3%
echo result: %ERRORLEVEL% >> %LOGFILE3%